...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Markrt')->group(function () {
        ...
        Route::prefix('property')->group(function () {
            ...
            Route::put('/update', [PropertyController::class, 'update'])->name('admin.market.property.update');
        ...
        Route::prefix('store')->group(function () {
            ...
            Route::put('/update', [StoreController::class, 'update'])->name('admin.market.store.update');
    ...
    Route::prefix('user')->namespace('User')->group(function () {
        ...
        Route::prefix('role')->group(function () {
            ...
            Route::put('/update', [RoleController::class, 'update'])->name('admin.user.role.update');
        ...
        Route::prefix('permission')->group(function () {
            ...
            Route::put('/update', [PermissionController::class, 'update'])->name('admin.user.permission.update');
